...
namespace MonogameSamples.Engine.Graphics.SceneSystem
{
    ...
    {
        public Scene2DUpdater scene2DUpdater;
        public Scene2DDrawer scene2DDrawer;
        ...
        public Scene2D(string name, RenderSystem renderSystem)
        {
            this.Name = name;
            this.renderSystem = renderSystem;
            scene2DDrawer = new Scene2DDrawer(this, renderSystem);
            scene2DUpdater = new Scene2DUpdater(this);

            renderSystem.AddComponent(new KeyValuePair<string, DrawableComponent>("SceneDrawer" + Name, scene2DDrawer));
        }
        ...
        public static Scene2D Load(RenderSystem renderSystem)
        {
            Scene2D scene = new Scene2D("temp", renderSystem);
